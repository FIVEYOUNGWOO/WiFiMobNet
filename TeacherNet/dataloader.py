...
class DetectionLoader:
    def __init__(self, dataloder, batchSize=1, queueSize=1024):
        # initialize the file video stream along with the boolean
        # used to indicate if the thread should be stopped or not
        self.det_model = Darknet("C:/Users/snl/PycharmProjects/Human-Pose-estimation/AlphaPose-pytorch/yolo/cfg/yolov3-spp.cfg")
        self.det_model.load_weights('C:/Users/snl/PycharmProjects/Human-Pose-estimation/AlphaPose-pytorch/models/yolo/yolov3-spp.weights')
...
class DataWriter:
    def __init__(self, save_json=False, json_path='output.json', queueSize=1024):
            ...
            if self.stopped:
                if self.save_json:
                    with open(self.json_path, 'w') as json_file:
                        json.dump(self.final_result, json_file)
                return
