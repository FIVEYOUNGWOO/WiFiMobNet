...
- Specifically, the prediction process minimizes the similarity loss between the Teacher's output $(x', y', c')$ and the Student's predictions (x<sup>*</sup>, y<sup>*</sup>), where $c'$ represents an entropy coefficient contributing to the loss function.
