...
k=0;
count = 0;
csi_folder_path = uigetdir('','Import CSI Folder');% Get images folder path and name
% csi_folder_path = 'C:\Users\s5281592\Downloads\CSI data\SNL_stop_motions\csi files\0_24_handsup';
